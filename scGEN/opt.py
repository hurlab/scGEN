...
#参数敏感性实验参数
parser.add_argument('--gamma', type=float, default=1, help='Hard-sample focusing factor gamma')#控制硬样本关注度的参数，范围从1-5
parser.add_argument('--alpha', type=float, default=1, help='high confidence rate')#控制两个loss的贡献参数 从{0.01,0.1,1,10,100}
